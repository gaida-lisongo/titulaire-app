...
import { QcmCorrectionModal } from './components/QcmCorrectionModal'
...
interface Resolution {
  ...
  reponses?: Array<{
    questionId: string
    reponse: string | number | Array<number>
  }>
...
function EmptyState() {
  return (
    <div className="text-center py-12 px-4">
      ...
      <h3 className="text-lg font-medium text-gray-900 mb-2">Aucune réponse QCM soumise</h3>
      <p className="text-gray-500 max-w-md mx-auto mb-6">
        Aucun étudiant n'a encore soumis de réponse pour ce QCM. Les réponses apparaîtront ici quand les étudiants commenceront à les envoyer.
      </p>
...
export default function QcmResolutionsPage({ params }: PageProps) {
  ...
  useEffect(() => {
    const loadResolutions = async () => {
      try {
        ...
        console.log('Resolutions QCM chargées:', data)
  ...
  return (
    <>
      <h2 className="text-xl font-semibold mb-6">Réponses des étudiants (QCM)</h2>
